 ...
 */
@WebServlet(name = "excluir_usuario", urlPatterns = {"/excluir_usuario"})
public class excluir_usuario extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       // request.getRequestDispatcher("form_Usuario_Lista.jsp").forward(request, response);
         request.getRequestDispatcher("pages/form_Usuario_Lista.jsp");        
